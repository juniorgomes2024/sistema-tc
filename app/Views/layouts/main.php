...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo $_SERVER['REQUEST_URI'] === '/users' ? 'active' : ''; ?>" href="/users">Usuários</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php echo $_SERVER['REQUEST_URI'] === '/login' ? 'active' : ''; ?>" href="/login">Login</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <footer class="bg-dark text-white text-center py-3">
        <p>© 2025 Fábrica de Campeões. Todos os direitos reservados.</p>
    </footer>
